        ...
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="mt-10 bg-white rounded-2xl p-8 shadow-sm border border-cream-200">
            <p className="text-charcoal-600 mb-6">
              Make a secure donation through PayPal. You can use your PayPal account
              or any major credit/debit card. Tax receipts available upon request.
            </p>
            ...
            >
              ...
              <input type="hidden" name="business" value="iefcecumenica@gmail.com" />
              <input type="hidden" name="item_name" value="IEF Canada Donation" />
              <input type="hidden" name="currency_code" value="CAD" />
              <input type="hidden" name="return" value="https://www.iefcanada.org/donate" />
              <input type="hidden" name="cancel_return" value="https://www.iefcanada.org/donate" />

              <button
                type="submit"
                className="inline-flex items-center justify-center gap-3 px-8 py-4 bg-[#0070ba] hover:bg-[#003087] text-white font-semibold rounded-xl transition-colors text-lg"
              >
            ...
            <p className="text-sm text-charcoal-500 mb-6">
              Secure payment powered by PayPal. All major credit cards accepted.
            </p>
